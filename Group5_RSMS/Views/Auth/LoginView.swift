...
struct LoginView: View {
    ...
    init() {
        UISegmentedControl.appearance().selectedSegmentTintColor = UIColor(red: 232/255, green: 213/255, blue: 148/255, alpha: 0.3)
    }
    ...
    private var brandHeader: some View {
        VStack(spacing: RSMSTheme.Spacing.md) {
            Text("Atelier")
                ...
                .fontWeight(.bold)
                .foregroundStyle(Color(red: 232/255, green: 213/255, blue: 148/255))
        }
    }
